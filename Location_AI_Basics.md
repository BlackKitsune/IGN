...
### 2.4 What is GenAI and how to use it with Geospatial data?
Generative AI is a type of **machine learning that can create new content**. These new creations are based on patterns that the AI has learned from the existing data used to train it. Unlike other types of AI, which may only be able to sort or predict, generative AI can produce entirely new content, such as text, images, maps or 3D designs.

Generative AI works by studying large sets of data in order to understand patterns. It uses specialised tools, such as **neural networks**, to **identify the relationships between different pieces of data**. Once these patterns have been learned, the AI can produce realistic and useful results (like in [MapDreamer](https://tjukanov.org/mapdreamer) project by Topi Tjakanov, where AI creates imaginary maps based on existing material)

#### Possible Geospatial Applications
One exciting use of generative AI is creating **synthetic data**. For example, it can generate fake but realistic satellite images, point clouds, or other datasets. This is helpful when real-world data is limited or hard to access: generative AI can be used to make land-use maps for areas where existing data is outdated or unavailable.  

Generative AI has also been integrated to GIS platforms, where **it can make working with geospatial data easier**. For instance, the user could ask the AI to “find all forested areas within 10 kilometers of this location,” and it would translate that into a technical spatial query and show the results to the user. This helps people who aren’t GIS experts use advanced tools. Another text-based example is GeoGPT, an open-source Large Language Model trained with geospatial data that the user can chat with and ask geospatial questions.

Another powerful application is *simulating scenarios*. Generative AI can model potential situations like urban growth, flooding, or evacuation routes. For example, it could predict how a city might expand in the future based on past trends and regulations. 

#### Challenges and Future Prospects
Although generative AI has great potential for geospatial work, it also presents challenges. While the material generated by AI improves with each iteration, it should always be carefully reviewed and its accuracy verified. Shortcomings in the AI model, training material or operation may affect the outcome, and these must be taken into account.
 
Generative AI has enormous potential in geospatial fields, particularly when combined with other tools and technologies. It can streamline processes, simplify tools and analyses for those without expertise in the field, and generate new datasets.
 
In the future, AI could become even smarter by combining different types of data to provide a broader and clearer picture of what is happening. AI models could also be specifically trained on geospatial data. This would enable them to understand and solve location-based problems even better.
